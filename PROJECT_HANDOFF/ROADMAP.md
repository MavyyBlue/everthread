...
**Current approved direction:** the temporary **QA infrastructure optimization program is complete**. QA-1 through QA-4 remain certified and must not be extended without new measured evidence. Dedicated location rollout is certified/player-accepted through **Loomworks Business District Location #14**, including the Run #235 physical-workplace correction: Loomworks is the employment/application + company hub, while suitable ordinary jobs use conditional workplace UI at their real implemented Everthread locations without replacing those locations' original purpose. CareerSystem/WorkplaceSystem/RelationshipSystem remain authoritative; no parallel employment/workplace truth is allowed. The current bounded task is documentation-only synchronization of Runs #234–#235 and repair of stale Run #232 status text found in the certified tree. After this documentation state is Green, select **exactly one Location #15** from the remaining **11** Astra-backed candidates. Mavyy may choose the creative candidate directly; before implementation, revalidate that candidate against current repository owners, routing, saves, determinism, and regressions. Astra references remain guidance rather than source truth. Date-capable future scenes should continue reusing the shared accepted-plan bridge; workplace-capable scenes should reuse the certified conditional workplace layer rather than inventing a second career screen or venue-specific employment state. Character Visual remains a separate approved direction with Run #170–#185 foundations preserved. Last durable feedback sweep remains **5 total / 0 unresolved by triage** against Run #192; this location rollout does not invent a newer feedback checkpoint. No Phase 11 label is implied.
