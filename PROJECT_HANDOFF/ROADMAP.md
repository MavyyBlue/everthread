...
## Current certified location rollout — Location #16 Everthread General Hospital — 2026-09-22

GitHub Actions **Run #242** (`35796139062`) certified expanded source **`d5d755762e8f33238a779d28cc47e67314169f0a`** from upload wrapper `83f8ce021abbd4a2f364b5a6af06e7c0699133d4`. Canonical preflight, certified artifact publication, Pages artifact upload, and deployment all succeeded. Mavyy completed direct Android/player acceptance and confirmed the Hospital works, closing Location #16's device gate. Save schema remains **18**.

Hospital remains a location adapter over HealthSystem treatment/rehab, StressConsequenceSystem therapy, and CareerSystem/WorkplaceSystem ordinary work. It introduces no Hospital-specific persistent state or migration. Loomworks remains the application/company hub; Hospital workplace UI is conditional on real local Medicine, Nursing, or Dentistry employment.
...
Closed-program context remains Run #166 / `7523f6919ad808f7d826c42cd471d61e1f4f4678`; the current certified save schema is **18**. The newest certified gameplay source is **Run #242 / `d5d755762e8f33238a779d28cc47e67314169f0a`**, the player-accepted Everthread General Hospital Location #16 baseline; Run #222 remains the durable Astra archive-provenance closeout. QA infrastructure remains the certified QA-4 process-isolated wall from Run #201, preserved unchanged. The location-scene chain is now Weaver Park + Threadtone (Run #187), immersive/drawer polish (Runs #189–#190), Central Everthread Bank (Run #192), Loomline Motors (Run #203), Hearthline Realty & Leasing (Run #205), Threadwell Residential District (Run #207), Crossroads Mall (Run #209), generalized scheduled-date navigation (Run #210), Nightjar Diner (Run #212), Pulseworks Gym (Run #224), Everthread Community School (Run #226), Everthread Market / Grocery Store (Run #228), Everthread City Hall (Run #230), Everthread Courthouse (Run #232), and Loomworks Business District (Run #234) with the actual-location workplace correction (Run #235), Everthread College (Runs #237–#238), and Everthread General Hospital (Run #242), with all prior Secret Yuki, Character Visual, Shared Lives, and closed Living World authorities preserved. Phase 8 — Everthread: Home, Phase 9 — Shared Lives, and Phase 10 — Living Everthread remain closed/certified; this post-closeout rollout is not Phase 11.
...
**Post-closeout status:** Run #168 certified UI iconography/Appearance reactivity; Run #170 certified the player Character Visual foundation; Run #172 certified the New Life mobile-width hotfix; Run #174 certified deterministic NPC portrait identity/reveal and descendant portrait continuity; Run #176 certified deterministic biological family resemblance/inheritance with canonical preflight **4/4** and Pages Green; Run #178 certified one authored secret-origin Yuki identity plus dedicated Hidden Threadroom routing/presentation; Run #180 certified reactive Astra-derived room/portrait presentation; Run #181 certified the full-screen portal and age-aware fallback-layout hotfix while preserving ordinary NPC/relationship simulation authority; Run #183 certified richer age presentation with stable identity, deterministic natural-hair graying, youth presentation gating, mature/elder detail projection, and profile/portrait parity; Run #185 certified the player-reproduced Secret Yuki provenance-routing hotfix, making the existing durable secret-code flag authoritative over bounded narrative memory; Run #187 certified the reusable dedicated-location-scene foundation with Weaver Park + Threadtone Music Studio while retaining the existing Town Map and gameplay owners; Run #189 certified the first direct player-review immersive/full-bleed presentation pass; Run #190 certified the player-reported unified utility-drawer hotfix; Run #192 certifies Central Everthread Bank as the third scene-backed location using focused views over existing finance/credit/payment/borrowing/investment owners; Run #194 certifies **QA-1**, adding bounded preflight stages and stronger evidence while preserving the full canonical wall and all gameplay authority; Runs #196–#197 certify **QA-2**, separating Engine/Test/App/Node compiler responsibilities and removing the redundant build-time `tsc -b` pass only after equivalence was proven; Run #199 certifies **QA-3**, preserving the complete serial wall while adding core-case, registered-suite, and top-level wall timing evidence; Run #201 certifies **QA-4**, isolating the measured heavy regressions into a second Node process with exact full-coverage partition verification and no reduced test parameters; Run #203 certifies **Loomline Motors as Location #4**, preserving QA-4 unchanged and routing vehicle/financing/licence interactions through existing owners; Run #205 certifies **Hearthline Realty & Leasing as Location #5**, reusing property/residential/mortgage/rental authorities and centralizing shared property eligibility projections in `PropertySystem`; Run #207 certifies **Threadwell Residential District as Location #6**, projecting real residence/household context through existing Residential Life, Shared Experience, Romantic Date, relationship, and action-economy owners without parallel neighborhood truth. Run #209 certifies **Crossroads Mall as Location #7**, routing personal shopping, collectibles, shared outings, and mall dates through existing owners while keeping collectible browsing RNG-neutral; Run #210 certifies the generalized **Schedule a Date → compatible location** flow using the existing pending-date truth and declarative scene companion/date metadata. Run #212 certifies **Nightjar Diner as Location #8**, reusing the real Nightjar personal-item catalogue, Shared Experience diner meal, and existing scheduled-date bridge without inventing a food economy or second date state. Run #224 certifies **Pulseworks Gym as Location #9**, projecting existing wellness, Shared Experience `gym_session`, and Romantic Date `gym_session` ownership while deliberately leaving combat challenge/lifecycle controls outside this bounded scene slice. Run #226 certifies **Everthread Community School as Location #10**, projecting existing Education, SchoolWorld, Youth Social, Shared Experience, institution-location, and action-economy owners while preserving compulsory leaving-age rules, current-classmate eligibility, post-secondary College locality, and external-school boundaries. Run #228 certifies **Everthread Market / Grocery Store as Location #11**, projecting the existing place-filtered Personal Inventory catalogue and owned-item history plus the existing wellness `diet` action while deliberately adding no hunger, consumable-grocery, pantry-quantity, nutrition-ledger, grocery-wallet, or second household-budget authority. Run #230 certifies **Everthread City Hall as Location #12**, projecting existing Politics career-world/public-office actions and BusinessSystem company creation/management while deliberately adding no municipal ledger, permit/fee system, election scheduler, civic reputation authority, or duplicate company registry. Run #232 certifies **Everthread Courthouse as Location #13**, projecting the existing pending legal case, legal status, and criminal record while preserving CrimeSystem case resolution, cash/legal RNG, and correctional/appeal ownership; it deliberately adds no shadow court docket, lawyer inventory, sentencing ledger, legal wallet, alternate action ledger, or crime catalogue. Run #234 certifies **Loomworks Business District as Location #14**, preserving CareerSystem/BusinessSystem authority while centralizing employment discovery/applications and company services. Run #235 certifies the **physical-workplace correction**: suitable ordinary full-time/part-time jobs use conditional workplace UI at real implemented venues, existing scenes retain their original purpose, employer/coworker truth stays in Career/Workplace/Relationship owners, old schema-17 records remain compatible without rewritten employment keys, and unmapped work stays district-level rather than fabricating Loomworks as a workplace. Run #237 certifies **Everthread College as Location #15**, reusing existing Education, SchoolWorld, workplace, and Shared Lives owners. Run #238 certifies the player-driven campus-life revision: one Admissions Kiosk, Library study/social/groups, and optional Residence Life dorm residency. The dorm is durable ResidentialLife state rather than a property/rental/loan, so save schema advances to 18 with deterministic empty-state migration; Living Map derives the current College home from the same residence projection while owned property remains distinct. Run #242 certifies **Everthread General Hospital as Location #16**, projecting existing treatment, rehabilitation, therapy, and conditional medical-workplace truth without new Hospital persistence, migration, or gameplay authority; Mavyy's Android check closes the Hospital player-acceptance gate.

**Current approved direction:** the temporary **QA infrastructure optimization program is complete**. QA-1 through QA-4 remain certified and must not be extended without new measured evidence. Dedicated location rollout is certified/player-accepted through **Everthread General Hospital Location #16 / Run #242**. Hospital preserves HealthSystem treatment/rehab, StressConsequenceSystem therapy, CareerSystem/WorkplaceSystem employment, Loomworks application/company ownership, schema **18**, save compatibility, and deterministic read-only browsing; it introduces no Hospital-specific durable state or migration. The ordinary NPC-profile scroll hotfix is also source-certified in Run #241 and now Android/player-accepted by Mavyy. The current bounded task is this documentation-only synchronization. After the docs state is Green, select **exactly one Location #17** from the remaining Astra-backed candidates and revalidate that candidate against current repository owners, routing, saves, determinism, and regressions before implementation. Astra references remain guidance rather than source truth. Date-capable future scenes should reuse the shared accepted-plan bridge; workplace-capable scenes should reuse the conditional workplace layer; residence-capable scenes must project through ResidentialLife rather than inventing property/rent truth. Character Visual remains a separate approved direction with Run #170–#185 foundations preserved. Last durable feedback sweep remains **5 total / 0 unresolved by triage** against Run #192; this location rollout does not invent a newer feedback checkpoint. No Phase 11 label is implied.
...
- tap an ordinary NPC node to open the existing rich NPC profile/action sheet; Run #178 adds one provenance-gated exception where the secret-origin Yuki routes first to the Hidden Threadroom, with mature profile actions still reachable from that room;
...
Player feedback/issue reporting is a playtest-driven cross-cutting priority and can temporarily gate Living World sequencing when Mavyy prioritizes active triaged reports. Device-local structured reporting is CI Green from Run #109; the secure Supabase Central Feedback Inbox is live from Run #110; token-authenticated player-visible status/disposition read-back is certified from Run #111. The fresh post-Run-#163 sweep found **4 total reports, all 4 triage-resolved, and no new report rows** after `2026-09-13 19:51:36.119407+00`. The stored review checkpoint points to certified `ab40d66808e0950f041a72681d573401926de8c0` at `2026-09-15 06:46:01.03675+00` with reviewed count 4. Feedback stays outside `GameState`; never expose Supabase service-role, GitHub, or other write credentials in the public Pages client.
