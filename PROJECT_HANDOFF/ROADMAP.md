...
Closed-program context remains Run #166 / `7523f6919ad808f7d826c42cd471d61e1f4f4678`, save schema **17**. The newest certified gameplay/source is **Run #172 / `5cf52a39d79f0835c2d9682e21d40c9ace7498c1`**, the New Life responsive-width hotfix over the Run #170 Character Visual foundation and closed Living World baseline. Phase 8 — Everthread: Home, Phase 9 — Shared Lives, and Phase 10 — Living Everthread remain closed/certified; Character Visual is not Phase 11.
...
**Post-closeout status:** Run #168 certified UI iconography/Appearance reactivity; Run #170 certified the player Character Visual foundation; Run #172 certified the New Life mobile-width hotfix with responsive layout **8/8**, canonical preflight **4/4**, and Pages Green.

**Current approved direction:** Character Visual. Run #170 is the certified player-creator/renderer foundation and Run #172 is its certified responsive-width hotfix. Next planned slices are deterministic NPC visual identities + relationship-based silhouette/full-portrait reveal, followed by family resemblance/inheritance and richer aging/presentation behavior. Each remains subject to repository inspection, player feedback, narrow ownership, migration/determinism review, and separate CI certification. No Phase 11 label is implied.
