...
The newest certified expanded **gameplay source** is **GitHub Actions Run #235** (`35391106935`) on expanded commit **`a1cfded8bc8453e16af955f3297bd2b8285ad3bf`**, save schema **17**. Run #234 certified **Loomworks Business District as dedicated Location #14**; Run #235 certified the player-driven physical-workplace correction that keeps Loomworks as the employment/application and company-services hub while suitable ordinary full-time/part-time jobs perform workplace activity at their real implemented Everthread locations. CareerSystem remains job authority, WorkplaceSystem/SocialWorld remains persistent boss/coworker authority, RelationshipSystem remains personal-relationship authority, and location scenes remain presentation/routing layers. Mavyy completed direct Android/player acceptance after Run #235 and reported the corrected flow works great. QA-4 remains unchanged with all 82 core cases and 77 specialized suites mandatory and exact handshake `core=81+1/82 specialized=76+1/77 overlap=0`; Location Scene is **182/182**, production is **237 modules**, and the temporary QA optimization program remains closed at QA-4. **The current task is documentation-only synchronization of accepted Location #14 and repair of stale Run #232 handoff wording discovered in the Run #235 tree. After this synchronization certifies, Location #15 remains deliberately unchosen and must be selected from the remaining 11 Astra-backed candidates after the normal fresh repository audit.** Phase 10 and the Living World Program remain closed/certified; this rollout is not Phase 11.
...
- Direct Android/player-side QA has confirmed the Map/navigation foundations plus Locations #4–#14 through Loomworks Business District and its actual-location workplace correction.
- The temporary **QA infrastructure optimization sequence remains complete**: QA-1 through QA-4 are certified, with no QA-5 planned without new measured evidence. Run #234 certifies Location #14; Run #235 certifies its workplace-routing correction and is the newest gameplay baseline. **After this documentation-only synchronization certifies, select exactly one Location #15 only after revalidating current owners/routing against repository truth.** No Phase 11 label is implied.
...
## Newest certified gameplay source — Run #235 — Loomworks Business District + physical workplace routing

- Run #234: wrapper `5780d2a00937c3c13a719b0fb1ac113a22b959be`, expanded source `9a78cce777469638b2dd5a0d9a30ee286bc997f4`, Actions Run `35377505019`, job `105705573775`. It adds Loomworks as Location #14 using Astra-derived `loomworks-business-district.png` and `work-desk.png`, plus focused employment/company presentation. Scene totals become **14 scenes / 43 semantic groups / 83 bindings / 27 selected Astra runtime assets**.
- Run #235: wrapper `dca60961c3ee8756e533ede0c53fd0e3be1d389e`, expanded source `a1cfded8bc8453e16af955f3297bd2b8285ad3bf`, Actions Run `35391106935`, job `105749418441`. Persistent correction diff from Run #234 is exactly **15 intended source/test files**, zero deletions, with no docs/assets/save-schema changes.
- **Physical workplace contract:** Loomworks is the employment/application + company hub, not a universal workplace. When a real implemented Everthread scene fits an active ordinary full-time/part-time job, that scene gains conditional **Your Workplace** UI while retaining all original scene purpose. Unmapped jobs remain district-level until a correct venue exists; generic Eastworks work must not be fabricated at Loomworks.
- CareerSystem continues to own employment/pay/performance/promotion; WorkplaceSystem/SocialWorld owns persistent managers, coworkers, teams and workplace metrics; RelationshipSystem owns chemistry/relationship state. Location routing creates no second employer, boss roster, coworker graph, salary, application ledger, or workplace truth.
- Existing saves remain schema **17**. Historical employment and SocialWorld keys are not rewritten; physical venue resolution is deterministic/RNG-neutral. New venue-aware offers reuse existing employment fields, use employer-specific application targets, and preserve location-aware role titles through promotion/demotion.
- Certified CI: Location Scene **182/182**, Working Everthread **50/50**, Living Map Projection **50/50**, Ownership/Work **35/35**, Town Map **46/46**, Institution Routing **42/42**, Cross-World Chemistry **43/43**, People/Threadspace **57 checks**, Commitment **10/10**, Integrated Long-Life **105/105**. QA-4 exact `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical Run #235 preflight passed **6/6**; production transformed **237 modules**. Certified source SHA `859bfcad99fea9e5d3e6fc937a680c2afb76be4b84e63be973ea4547999430aa`; dependency SHA `ebb9f8c1458089744ed868c3ab7b7a816230e79fd953adf277374b36c971408d`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10565922723` (`a8f12f76400f6f5929250963da9a38fb6af08d52d4d90291e80e090dbc4ead6d`); Pages artifact `10565957748` (`a797ee62c1a300cd681495adbb77f0ca6fa066831972552a98e5d7220b51fe30`); deployment Green.
- **Player acceptance:** Mavyy validated the corrected actual-location workplace flow on Android after Run #235 and reported it works great. Treat Location #14's tactile/device gate as closed.
- **Documentation drift:** the certified Run #235 tree still had top-level handoff text pinned to Run #232 / Location #14 unchosen. This docs-only closeout repairs that stale status; it does not change gameplay or certification evidence.
- **Next gate after docs certification:** choose exactly one Location #15 from the remaining **11** Astra-backed candidates and run the standard owner/source/test audit before implementation.

## Prior certified gameplay source — Run #232 — Everthread Courthouse dedicated scene

- Upload wrapper `b197ce9204c0f4040906b3adb9c1a03140424432`; expanded certified source `1ba66017ccbb21211e5c307d630ef72cf1e20346`; Actions Run `35372584755`, job `105689785838`. Net persistent diff from synchronized Run #231 `275501a8c4962734be90b64b1b14593bba10cabb` is exactly **6 intended files**: Courthouse background, new thin `CourthouseLocationPanel`, shared scene/data/system wiring, and expansion of the existing Location Scene regression. The Courthouse reuses the already-certified `records-desk.png` byte-for-byte instead of importing a duplicate prop.
- **Everthread Courthouse is the thirteenth dedicated location scene.** Its three semantic groups are **Case desk**, **Courtroom**, and **Consultation room**, exposing four scene bindings: Your Case, Legal Status, a second Your Case entry, and Legal Record. Certified scene totals are now **13 scenes / 40 semantic groups / 75 scene action bindings / 25 selected Astra runtime assets**.
- Courthouse adds no duplicate legal case, court docket, lawyer inventory, sentencing ledger, legal wallet, conviction history, prison/appeal owner, action ledger, or RNG authority. Pending charges, representation costs, plea choice, case resolution, convictions/sentences, legal status, criminal record, cash mutation, and legal RNG remain the existing CrimeSystem/GameEngine paths. Correctional/prison actions and appeal authority remain outside this scene.
- Save schema remains **17**. No migration, QA topology change, new legal content authority, RNG stream, runtime-ID authority, event scheduler, or scene-local durable state was added. Read-only case/status/history browsing is save-, RNG-, runtime-ID-, and action-ledger-neutral until an established legal command commits.
- Location Scene regression expanded **151 → 162** and passed **162/162**. Connected CI remains Green: Town Map **46/46**, Institution Routing **42/42**, and Integrated Long-Life **105/105**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 47,373 ms**: Engine TypeScript **4,079 ms**, Test TypeScript **6,168 ms**, App TypeScript **9,292 ms**, Node/Vite Config TypeScript **960 ms**, complete regression wall **22,254 ms**, production build **4,605 ms**. Production transformed **233 modules**.
- Certification source SHA `cf0732b98fe1d613e8061968f489ba438038315fcb525aa5483943348d884d9b`; dependencies `1c2ec0683b75dcade93311d03673bf2f3b62b63355e374b0ef1533ddc29002b7`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10559170563` (`2999369185941ade10235ad24f5e7b713b458b2201848cfef1578539a9d3898f`); Pages artifact `10558975706` (`bb8361249cfa7321968011c22a1ec35ca955292163c2813a2b1f25e2edf01eb3`); Pages deployment Green.
- **Player acceptance:** Mavyy completed direct Android/player validation after Run #232 and reported the Courthouse worked. Treat Location #13's tactile/device gate as closed. **Next gate after this documentation-only synchronization certifies:** choose exactly one Location #14 from the remaining 12 Astra-backed candidates, then perform the normal fresh owner/source/test audit before implementation.

## Prior certified gameplay source — Run #228 — Everthread Market / Grocery Store dedicated scene

- Upload wrapper `0e39d2710288beace3158a43c20c90e0fede7af5`; expanded certified source `96042ae010c5962f59b466c89e82bce0c2bf9a5c`; Actions Run `35313340457`, job `105499683779`. Net persistent diff from synchronized Run #227 `16c8c0b4cc847d208022a9f0e1221749479ef687` is exactly **7 intended files**: Market background + grocery-cart assets, new thin `MarketLocationPanel`, shared scene/data/system wiring, and expansion of the existing Location Scene regression.
- **Everthread Market is the eleventh dedicated location scene.** Its three semantic groups are **Shopping cart**, **Produce stand**, and **Pantry shelves**, exposing three scene bindings: Food & household items, Eat intentionally, and Your Market purchases. Certified scene totals are now **11 scenes / 34 semantic groups / 63 scene action bindings / 22 selected Astra runtime assets**.
- Market adds no duplicate personal inventory, cash balance, household budget, nutrition ledger, pantry quantity, hunger state, consumable grocery stack, action ledger, or RNG authority. Food & household shopping and Market purchase history remain projections over the existing place-filtered Personal Inventory catalogue and owned-item records; purchases remain the established `gameEngine.purchasePersonalItem` path. Eat intentionally remains the existing wellness `diet` action rather than an effect attached to buying groceries.
- Save schema remains **17**. No migration, QA topology change, new food/economy content authority, RNG stream, runtime-ID authority, event scheduler, or scene-local durable state was added. Browsing Market catalogue, ownership, price/availability presentation, and action availability remains save-, RNG-, and runtime-ID-neutral until an established action actually commits.
- Location Scene regression expanded **126 → 136** and passed **136/136**. Connected CI remains Green: Town Map **46/46**, Institution Routing **42/42**, Player Profile/Inventory **63/63**, and Real Gifts **60/60**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 49,318 ms**: Engine TypeScript **4,216 ms**, Test TypeScript **6,512 ms**, App TypeScript **9,413 ms**, Node/Vite Config TypeScript **996 ms**, complete regression wall **23,632 ms**, production build **4,535 ms**. Production transformed **231 modules**.
- Certification source SHA `69d9faa7d60db73422ebf54b44544a6c288ffd5ca163da2f0d11d56e27951554`; dependencies `9e7aaecacc54467fc88371759ab0881d347d5732928dc21282845240757f3215`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10534102937` (`e41943a173f1af31e8ec2fdae9b831cd0530a8b71d72ce13644306d6abc2c325`); Pages artifact `10534387024` (`08783fa5460aa9a5bedebfcc32e3b7b4b7a644bc439c3021a035d50f28c6967f`); Pages deployment Green.
- **Player acceptance:** Mavyy completed direct Android/player validation after Run #228 and reported the Grocery Store works correctly. Treat Location #11's tactile/device gate as closed. **Next gate after this documentation-only synchronization certifies:** choose exactly one Location #12 from the remaining 14 Astra-backed candidates, then perform the normal fresh owner/source/test audit before implementation.

## Prior certified gameplay source — Run #226 — Everthread Community School dedicated scene

- Upload wrapper `638564e03f5526f0039b954e1c7ee6c68cfd89ea`; expanded certified source `72666ff23d167c4088bde1b13fd5a1a121bf45af`; Actions Run `35308793999`, job `105486329254`. Net persistent diff from synchronized Run #225 `e3b540335271285492a1e88d85b9df52223c1fa4` is exactly **7 intended files**: School background + student-desk assets, new thin `SchoolLocationPanel`, shared scene/data/system wiring, and expansion of the existing Location Scene regression.
- **Everthread Community School is the tenth dedicated location scene.** Its three semantic groups are **Study desk**, **Classroom**, and **Activity board**, exposing seven scene bindings: Study harder, Skip class, School record, Leave education, Clubs & teams, Volunteer, and School social. Certified scene totals are now **10 scenes / 31 semantic groups / 60 scene action bindings / 20 selected Astra runtime assets**.
- School adds no duplicate enrollment state, academic-performance state, attendance/conduct ledger, school-group registry, peer list, action ledger, or RNG authority. Study harder / Skip class / Leave education remain `EducationSystem` actions; records, groups, and volunteering remain `SchoolWorldSystem` truth; School social projects only current SchoolWorld classmates and commits through the existing Shared Experience `everthread-school` / `school_social` plan.
- The physical scene is intentionally local. It only projects the active compulsory-school world anchored to Everthread Community School; post-secondary education remains anchored to Everthread College, and remote school worlds remain unavailable from this scene. Compulsory leaving-age gates, youth social ceilings, existing action limits, and skip-class RNG/consequences remain authoritative.
- Save schema remains **17**. No migration, QA topology change, new education content authority, new RNG stream, runtime-ID authority, event scheduler, or scene-local durable state was added. Browsing records/groups/availability/classmates is save-, RNG-, runtime-ID-, and action-ledger-neutral.
- Location Scene regression expanded **111 → 126** and passed **126/126**. Connected CI remains Green: Shared Experience **53/53**, Youth Social **40/40**, Working Everthread **50/50**, Town Map **46/46**, and Institution Routing **42/42**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 46,357 ms**: Engine TypeScript **4,113 ms**, Test TypeScript **5,920 ms**, App TypeScript **8,821 ms**, Node/Vite Config TypeScript **974 ms**, complete regression wall **22,006 ms**, production build **4,508 ms**. Production transformed **230 modules**.
- Certification source SHA `93add0d2b9753fb1b9fb53d2b0b02996ad7eea01f9b1067ccbe79c0544c1bd53`; dependencies `a9e8cd5dc446e419b8c3415edb93853293717c55c6c48d1c9e8f183c22deba92`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10532801871` (`aa00d2cd0107f6d45172e9deff3ece7a03f8699ce89f2fe01faaf860acb0fb99`); Pages artifact `10532557229` (`388fe469095e6e060484477e0c8be363c6588a2b0a90dc7b4f2f6e5b7b53b232`); Pages deployment Green.
- **Player acceptance:** Mavyy completed direct Android/player validation after Run #226 and reported School works great. Treat Location #10's tactile/device gate as closed. **Next gate after this documentation-only synchronization certifies:** choose exactly one Location #11 from the remaining 15 Astra-backed candidates, then perform the normal fresh owner/source/test audit before implementation.

## Prior certified gameplay source — Run #224 — Pulseworks Gym dedicated scene

- Upload wrapper `2c80c1617a50d9d5354707882b839386d3c97164`; expanded certified source `08a27517d42081ddb22c6587308a15da55669d2c`; Actions Run `35305049420`, job `105475409391`. Net persistent diff from synchronized Run #223 `0e25206cbad8fa043d86abdab0283c367f8c9882` is exactly **6 intended files**: Pulseworks background + fitness-bench assets, shared scene/data/system wiring, and expansion of the existing Location Scene regression.
- **Pulseworks Gym is the ninth dedicated location scene.** Its three semantic groups are **Training bench**, **Fitness floor**, and **Martial arts room**, exposing five scene bindings: Work out, Train together, Workout date, a second Work out affordance, and Martial arts. Certified scene totals are now **9 scenes / 28 semantic groups / 53 scene action bindings / 18 selected Astra runtime assets**.
- Pulseworks adds no duplicate fitness state, combat-career state, relationship/date state, action ledger, or RNG authority. Work out and Martial arts remain existing wellness activities; Train together remains Shared Experience `gym_session`; Workout date remains Romantic Date `gym_session` using the one authoritative pending accepted date. Astra's `combat.train`, `combat.fight`, and `combat.leave` concepts are deliberately deferred because the current Location Scene contract does not own challenge/minigame or combat-career lifecycle routing.
- Save schema remains **17**. No migration, QA topology change, new content catalog, RNG stream, runtime-ID authority, event scheduler, or scene-local durable state was added.
- Location Scene regression expanded **99 → 111** and passed **111/111**. Connected CI remains Green: Shared Experience **53/53**, Dating Momentum **61/61**, Town Map **46/46**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 51,123 ms**: Engine TypeScript **4,259 ms**, Test TypeScript **6,814 ms**, App TypeScript **9,589 ms**, Node/Vite Config TypeScript **1,033 ms**, complete regression wall **24,697 ms**, production build **4,713 ms**. Production transformed **229 modules**.
- Certification source SHA `0184959e200056970410f3bd0caea2bccc75e1a3598bffb47d90817db9294a8d`; dependencies `e84ab9c2002ac17f4ea6964ed4d750e1cee349de4cd40cf2be184efbd2285b55`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10530537991` (`3f077b1aa2c9d1f783225853c7f85e6f4fca4dd51fd43f947b9bf54010dc196e`); Pages artifact `10530478164` (`e78df25d7b60ab5a695a7ead9ca4cc99778f17a183ec5bed947c8fa4cf172c97`); Pages deployment Green.
- **Player acceptance:** Mavyy completed direct Android/player validation after Run #224 and reported Pulseworks works great. Treat Location #9's tactile/device gate as closed. **Next gate after this documentation-only synchronization certifies:** select exactly one Location #10 from the remaining 16 Astra-backed candidates after a fresh owner/source/test audit.

## Prior certified repository/handoff source — Run #222 — Astra source archive closeout
...
- Nightjar adds no duplicate food economy, personal inventory, relationship/date state, or action economy. Counter goods come from the existing six Nightjar personal-item definitions and purchase through the established Personal Inventory owner. Shared meals/date outcomes remain Shared Experience / Romantic Date truth. Browsing consumes no gameplay RNG.
- Save schema remains **17**. No migration, QA topology change, new content catalog, RNG stream, runtime-ID authority, or event scheduler was added.
- Location Scene regression is **99/99**. Connected CI remains Green: Shared Experience **53/53**, Dating Momentum **61/61**, Player Profile/Inventory **63/63**, Youth Social **40/40**, Cross-World Chemistry **43/43**, Shared Lives closeout **41/41**, Town Map **46/46**, institution routing **42/42**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 27,450 ms**: Engine TypeScript **2,266 ms**, Test TypeScript **3,314 ms**, App TypeScript **4,994 ms**, Node/Vite Config TypeScript **566 ms**, complete regression wall **13,182 ms**, production build **3,037 ms**. Production transformed **229 modules**.
- Certification source SHA `a4590a473e8d9a0d2b5fbf27a7984e3ac4dc630199aaaaa5ace28222c7ac7e56`; dependencies `843e6871a19ef8a299745b910df885172a0d5724786764b285e23b3f8c7bf48b`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10520691404` (`1e229d6547706ea87b3d41233da1581dcbf8f5bc7580085ddcd01263c37c3799`); Pages artifact `10520731398` (`c5abc53dc50ca753be9bf59b38b88a50ecd3a3aa07605e426d8fc691e3f7276e`); Pages deployment Green.
- **Player acceptance:** Mavyy completed direct Android/player validation after Run #212 and reported Nightjar works. Treat Location #8's tactile/device gate as closed.
...
- The five-part source archive remains certified provenance and does not become gameplay authority. **Next gate after the Location #14 documentation synchronization is Green:** select exactly one Location #15 from the remaining 11 Astra-backed candidates after a fresh owner/source/test audit. Do not preselect from historical action maps.

## Newest certified repository/gameplay source — Run #210 — scheduled-date navigation closeout

- Upload wrapper `4803063f5c5dbc1ee5b0d52af8fd947b0657ec9e`; expanded certified source `3a7e79010d55af3e6c75540f1e1ac1468bc7aaf5`; Actions Run `35265443401`, job `105351341114`. Net persistent diff from Run #209 `487ea66dd589bf7d35efce29ab8ebba8a5313b44` is exactly **6 intended source/test files**; the importer reports 7 changed paths only because it removes transient `everthread-source.zip`.
- NPC-profile dating now stops at invitation/acceptance. The established `relationship.romance.pendingDate` remains the single durable accepted-plan truth; compatible dedicated scenes project that plan and complete the existing Romantic Date owner. Weaver Park, Threadwell Residential District, and Crossroads Mall all consume the same contract.
- Location companion/date plans moved from a hardcoded scene-system registry into declarative `LOCATION_SCENE_ACTIONS` metadata. `LocationScene` accepts companion actions generically, so future date-capable scenes inherit the flow by declaring an existing valid place/activity mapping. No new scheduler, calendar, event queue, date ledger, save field, or migration was introduced.
- Save schema remains **17**. Scene totals remain **7 scenes / 22 semantic groups / 44 action bindings / 14 selected Astra runtime assets**. Town places remain **25** and routed institution services remain **29**.
- Location Scene regression is **88/88**. Connected CI is Green: Dating Momentum **61/61**, Shared Experience **53/53**, Shared Lives closeout **41/41**, AI Interaction **82/82**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 37,749 ms**: Engine TypeScript **3,075 ms**, Test TypeScript **4,510 ms**, App TypeScript **7,405 ms**, Node/Vite Config TypeScript **793 ms**, complete regression stage **18,031 ms**, production build **3,924 ms**. The wall itself reports **5/5 in 17,913 ms** and production transformed **228 modules**.
- Certification source SHA `0559b935bcefb072737084603f2bba27f1d1c4b1f9642525e5ec1c6c683a823f`; dependencies `8616774696662095fcb59536665c2095edfe5c1253eda023899cd21d59904e4f`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10516895640` (`becc86c5b19a883b0ff32d7dc4ff64fa79c42bfc097c65997a838beb5a048738`); Pages artifact `10516386442` (`af471a12334e710971e5094afcdd04ded8497dc334fb4834241e54aac71d32d2`); Pages deployment Green.
- **Player acceptance:** Mavyy completed direct Android/player validation after Run #210 and reported the generalized scheduled-date flow works. Treat the Crossroads/date-navigation tactile gate as closed. **Next gate after this documentation-only sync certifies: select exactly one Location #8 from remaining Astra-backed candidates after a fresh owner/source/test audit.**

## Certified repository/gameplay source — Run #209 — Crossroads Mall dedicated scene

- Upload wrapper `d2736dd98b5741c1a51cb410fc83de32b66d6e93`; expanded certified source `487ea66dd589bf7d35efce29ab8ebba8a5313b44`; Actions Run `35260873402`, job `105335962298`. Net persistent diff from synchronized Run #208 `e3f7f081e0ef5ddc864cc559deddc1c72a5a26d4` is exactly **10 intended files**; the importer reports 11 changed paths only because it removes transient `everthread-source.zip`.
- **Crossroads Mall is the seventh dedicated location scene.** Its three semantic groups are **Shopping counter**, **Gift boutique**, and **Mall concourse**, exposing eight focused bindings for personal-item shopping, collectibles, gifts, owned mall purchases, browse-together, games, movies, and Mall date. Certified scene totals become **7 scenes / 22 semantic groups / 44 scene action bindings / 14 selected Astra runtime assets**.
- Crossroads adds no duplicate shop inventory, collectible ledger, relationship/date state, or mall economy. Personal items remain `PersonalInventorySystem` truth; collectibles remain `PropertySystem` assets; Shared Experience and Romantic Date retain social/date mutation. Collectible browsing is RNG-neutral; only the established purchase command rolls market price/authenticity/condition/value.
- Location Scene regression passed **82/82**. Canonical CI preflight passed **6/6 in 49,066 ms** and production transformed **228 modules**. Certification source SHA `2a8b4d72934ffb7b6a383144e997c123afa5447d845bce08ddf3490938cb849c`; dependencies `f91df36b7e85c78cec55af8aae4b7a1a5d7ecc658e14b9c5c22be579514cf68a`; certified artifact `10514552885`; Pages artifact `10514503137`; deployment Green.
- Initial Android review found the Mall Date eligibility/navigation seam. Run #210 resolves it generically and is the final player-accepted Crossroads closeout baseline.

## Newest certified repository/gameplay source — Run #207 — Threadwell Residential District dedicated scene

- Upload wrapper `6506073b6d5d83bb1d5cd989043baf439f8ba199`; expanded certified source `90e16923efa896da52750e7241b5387ca02da1ad`; Actions Run `35253421670`, job `105311055912`. Net persistent diff from synchronized Run #206 `c5cd9c87417b53494f47095c278666b5a1487951` is exactly **8 intended files**: Threadwell background + neighborhood-board assets, new `ResidentialLocationPanel`, shared scene/data/system wiring, a small reusable current-residence presentation extraction, generalized scene companion-plan bridge, and expansion of the existing Location Scene regression. The importer reports 9 changed paths only because it also removes transient `everthread-source.zip`.
- **Threadwell Residential District is the sixth dedicated location scene.** Its three semantic groups are **Neighborhood board**, **Home entrance**, and **Courtyard**, exposing seven focused bindings: Current residence, Known households, Visits, Home hangout, Cook together, Sleepover, and At-home date. Certified scene totals are now **6 scenes / 19 semantic groups / 36 scene action bindings / 12 selected Astra runtime assets**. Town places remain **25** and routed institution services remain **29**.
- Threadwell adds no duplicate residence, neighborhood, relationship, or household truth. `ResidentialLocationPanel` reads the existing residence projection and real known households; residential plans terminate in established `ResidentialLifeSystem` / `GameEngine` actions; home hangouts and dates remain owned by Shared Experience / Romantic Date systems. The illustrated houses are presentation only and never imply player ownership. The generalized companion-plan bridge is shared with Weaver Park rather than introducing a Threadwell-only date path.
- Save schema remains **17**. No migration, QA topology change, new content catalog, action-energy owner, RNG stream, or runtime-ID authority was added.
- Location Scene regression is **70/70**. Connected CI is Green: Residential Life **69/69**, Shared Experience **53/53**, Dating Momentum **61/61**, Shared Lives closeout **41/41**, Town Map **46/46**, institution routing **42/42**. QA-4 remains exact at **82 core / 77 specialized / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 27,925 ms**: Engine TypeScript **2,471 ms**, Test TypeScript **3,417 ms**, App TypeScript **5,324 ms**, Node/Vite Config TypeScript **604 ms**, complete regression wall **12,957 ms**, production build **3,073 ms**. Production transformed **227 modules**.
- Certification source SHA `d04640b3f62e2bb9e675afd31717c6c6718341640205c704e5b0147773a1f4e6`; dependencies `2da3e914d915ba5f62ba8ad09d3d5a29df6bf3b659a381227215f411db661294`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10511147329` (`ea83f0542584f4e9fe922227c1dc0be78b79c5db30322a17adb680e710da62e3`); Pages artifact `10511062309` (`0aec413a0849bd100a24b6e77705c08453d89f5cbb548caa368edb8ce77f84ec`); Pages deployment Green.
- **Player acceptance:** Mavyy completed the direct Android/player pass successfully after Run #207 and reported Threadwell works well. Treat Location #6's tactile/device gate as closed. **Next gate after this documentation-only sync certifies: select exactly one Location #7 from the remaining Astra-backed candidates after a fresh owner/source/test audit.**

## Newest certified repository/gameplay source — Run #205 — Hearthline Realty & Leasing dedicated scene

- Upload wrapper `75af208552577ee3e66149e2685f98b334ec56c0`; expanded certified source `5ea3d448a90c8b82044d33b5f4e31ef99e5b80e9`; Actions Run `35244915393`, job `105282529337`. Net persistent diff from synchronized Run #204 `42bdf7501a67def2103c66cccbb204b71e82b724` is exactly **9 intended files**: Hearthline background + home-model assets, `RealtyLocationPanel`, shared scene presentation/data/system wiring, `PropertySystem` availability ownership, legacy Assets consumption of the same owner checks, and the existing Location Scene regression. The workflow importer reports 10 changed files only because it also removes transient `everthread-source.zip`.
- **Hearthline Realty & Leasing is the fifth dedicated location scene.** Its three semantic groups are **Home display**, **Property wall**, and **Property office**, exposing four focused bindings: Browse homes, Mortgage options, Current residence, and Your homes & rentals. Certified scene totals are now **5 scenes / 16 semantic groups / 29 scene action bindings / 10 selected Astra runtime assets**. Town places remain **25** and routed institution services remain **29**.
- Hearthline adds no duplicate property market, mortgage ledger, residence state, rental ledger, payment state, or tenant lease system. The focused panel reuses the authoritative property catalogue/housing index, `PropertySystem` purchase / Make Home / renovation / rent-out / sale paths, `AssetFinancingSystem` mortgage flow, `ResidentialLifeSystem` residence projection, secured-loan status/payoff, and existing Bank payment authority. The previously inline adulthood / primary-residence eligibility checks are now exposed by `PropertySystem` read-only availability helpers and consumed by both legacy Assets UI and Hearthline, reducing UI-rule drift.
- Astra's caveat remains binding: Everthread supports **landlord rent-out of owned property**, but the certified source does not own a tenant lease-signing / lease-selection mechanic, so Location #5 does not invent one. Save schema remains **17**.
- Location Scene regression is **60/60**. Connected CI remains Green, including Residential Life **69/69**, Asset Financing **77/77**, Payment & Asset Management **81/81**, Town Map **46/46**, and institution routing **42/42**. QA-4 topology remains exact: **82 core cases / 77 specialized suites / zero overlap**, handshake `core=81+1/82 specialized=76+1/77 overlap=0`.
- Canonical CI preflight passed **6/6 in 32,517 ms**: Engine TypeScript **2,635 ms**, Test TypeScript **4,124 ms**, App TypeScript **6,611 ms**, Node/Vite Config TypeScript **698 ms**, complete regression wall **15,093 ms**, production build **3,346 ms**. The wall itself reports **5/5 in 14,971 ms** and production transformed **226 modules**.
- Certification source SHA `ca5e6a8c89e778d01337f9460cd6a3014a898ff1a2235e67c713d8d5404a6f3e`; dependencies `05a99dfd7074a8972e109b6b824b81bb431ad211b22e734a2c903ae5be862f73`; lock `da0cd3cd1a975e0d7d6a8466d55826bc8277dc35f55e7685be85d7ecf11f2886`; certified artifact `10507520649`; Pages artifact `10507450705`; Pages deployment Green.
- **Player acceptance:** Mavyy completed the direct Android/player pass successfully after Run #205 and reported Hearthline functions very well. Treat the location's tactile/device gate as closed. **Next gate after this documentation-only sync certifies: select exactly one Location #6 from the remaining Astra-backed candidates after a fresh owner/source/test audit.**
...
- Base suite remains **82/82** and now emits 82 case timings. Certified core time is **19,832 ms**; the 25-life multi-life integration smoke is **16,264 ms** (~82% of core time).
...
- QA-3 subsequently certified registry/timing in Run #199 and now supplies the evidence used to bound QA-4.
...
- Historical Bank review plus Loomline and Hearthline device-acceptance gates are complete. Run #207 now certifies Threadwell Residential District as Location #6 and Mavyy has completed its Android acceptance; the current next gate is documentation synchronization before selecting exactly one Location #7.
...
- Local current schools resolve to the existing School/College anchors. Active ordinary full-time/part-time workplace worlds resolve through the certified physical-workplace catalogue: a suitable implemented venue is used when one exists, while otherwise the workplace remains district-level rather than fabricating a landmark. Loomworks is deliberately not a generic workplace fallback. Remote work/school worlds stay remote and receive no Everthread district.
