...
- `PHASE6_CREDIT_DEBT.md` — active Phase 6 credit/debt architecture: 6A and 6B1 CI-Green foundations, current 6B2 secured-delinquency/collateral candidate, and later personal-borrowing/recovery sequence.
