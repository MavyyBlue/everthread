...
export function continueAsChild(state:GameState,childId:string):EngineResult {
  ...
  state.specialCareers={};state.pets=[];state.familyPlanning={};state.residentialLife={};state.actionLedger={age:state.character.age,uses:{},lastUsedAge:{},revision:0};resetConsequenceSchedulerForNewProtagonist(state);
