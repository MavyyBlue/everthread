...
export function emigrate(_state:GameState,_countryId:string,_city?:string):EngineResult {return{success:false,messages:[{text:'Everthread is your permanent home. Use Travel for temporary vacations and family trips.'}]};}
