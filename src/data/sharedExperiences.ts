...
export const SHARED_EXPERIENCE_ACTIVITIES:readonly SharedExperienceActivityDefinition[]=[
  ...
  {id:'college_social',label:'Socialize on campus',minAge:17,placeIds:['everthread-college'],preferenceTags:['social','music','games'],baseEnjoyment:1,copy:{lead:'spent time together around',memoryLead:'spent time together around'}},
