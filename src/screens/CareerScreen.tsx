...
import { availablePartTimeJobs as partTimeOptionsFor, currentWorkplaceWorld, partTimeHourLimit, totalPartTimeHours, workplaceForCareerRecord } from '../systems/WorkplaceSystem';
...
export function CareerScreen({state,onResult,routeRequest,onReturnToMap}:{state:GameState;onResult:ActionResultHandler;routeRequest?:InstitutionRouteRequest;onReturnToMap?:()=>void}){
  ...
  const workLocation=workplace?workplaceWorldLocation(workplace):undefined;
