...
export function runMusicCareerRegression(){
  ...
  const legacyYears=createNewGame({seed:'phase4d4-legacy-music-years-regression'});legacyYears.character.age=13;legacyYears.currentYear=2039;legacyYears.specialCareers.music={active:true,skill:70,reputation:55,songsReleased:4,albumsReleased:2,years:13,fanbase:8000};ensureSpecialCareerWorld(legacyYears,'music','vocals',{announce:false});legacyYears.character.age=21;legacyYears.currentYear=2047;legacyYears.specialCareers.music.years=21;processMusicCareerYear(legacyYears);
