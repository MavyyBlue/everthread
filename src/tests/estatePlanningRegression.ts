...
export function runEstatePlanningRegression(){
  ...
  verify(fresh.saveVersion===16&&SAVE_VERSION===16,'Phase 5A estate planning remains available under current save schema 16');
  ...
  verify(migrated.saveVersion===16&&Array.isArray(migrated.inheritance.assetBequests),'existing v9 saves migrate deterministically while preserving estate-planning defaults');
