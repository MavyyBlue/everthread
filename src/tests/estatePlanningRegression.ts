...
export function runEstatePlanningRegression(){
  ...
  verify(fresh.saveVersion===17&&SAVE_VERSION===17,'Phase 5A estate planning remains available under current save schema 17');
  ...
  verify(migrated.saveVersion===17&&Array.isArray(migrated.inheritance.assetBequests),'existing v9 saves migrate deterministically while preserving estate-planning defaults');
