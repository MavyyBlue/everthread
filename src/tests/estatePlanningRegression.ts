...
export function runEstatePlanningRegression(){
  ...
  verify(fresh.saveVersion===15&&SAVE_VERSION===15,'Phase 5A estate planning remains available under current save schema 15');
  ...
  verify(migrated.saveVersion===15&&Array.isArray(migrated.inheritance.assetBequests),'existing v9 saves migrate deterministically while preserving estate-planning defaults');
