...
export function runEstatePlanningRegression(){
  ...
  verify(fresh.saveVersion===18&&SAVE_VERSION===18,'Phase 5A estate planning remains available under current save schema 18');
  ...
  verify(migrated.saveVersion===18&&Array.isArray(migrated.inheritance.assetBequests),'existing v9 saves migrate deterministically while preserving estate-planning defaults');
