...
export function runAssetDelinquencyRegression(){
  ...
  verify(SAVE_VERSION===18,'Phase 6B2 delinquency state remains valid under current schema 18');
  ...
  verify(restored.saveVersion===18,'secured delinquency persists through current schema normalization');
