...
export function runAssetDelinquencyRegression(){
  ...
  verify(SAVE_VERSION===16,'Phase 6B2 delinquency state remains valid under current schema 16');
  ...
  verify(restored.saveVersion===16,'secured delinquency persists through current schema normalization');
