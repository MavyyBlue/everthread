...
export function runAssetDelinquencyRegression(){
  ...
  verify(SAVE_VERSION===17,'Phase 6B2 delinquency state remains valid under current schema 17');
  ...
  verify(restored.saveVersion===17,'secured delinquency persists through current schema normalization');
