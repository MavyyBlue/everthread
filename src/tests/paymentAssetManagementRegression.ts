...
export function runPaymentAssetManagementRegression(){
  ...
  verify(SAVE_VERSION===16&&fresh.saveVersion===16,'Phase 6B3 payment state remains valid under current schema 16');
  ...
  verify(migrated.saveVersion===16,'schema-11 saves migrate to current schema 16');
  ...
  verify(restored.saveVersion===16&&restoredCard.autoPay===false&&restoredCard.pastDueAmount===40,'current-schema save roundtrip preserves card payment preferences and arrears');
