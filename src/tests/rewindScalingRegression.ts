...
export function runRewindScalingRegression(){
  ...
  verify(migrated.saveVersion===17&&migrated.yearlySnapshots.length===MAX_REWIND_SNAPSHOTS,'current-schema saves should receive retention normalization without a schema bump');
