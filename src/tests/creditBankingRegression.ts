...
export function runCreditBankingRegression(){
  ...
  verify(fresh.saveVersion===16&&SAVE_VERSION===16,'Phase 6A credit state remains valid under current save schema 16');
  ...
  verify(migrated.saveVersion===16&&Boolean(migrated.finances.credit),'v10 saves migrate to current schema 16 with credit state');
