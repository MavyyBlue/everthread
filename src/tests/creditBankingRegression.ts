...
export function runCreditBankingRegression(){
  ...
  verify(fresh.saveVersion===15&&SAVE_VERSION===15,'Phase 6A credit state remains valid under current save schema 15');
  ...
  verify(migrated.saveVersion===15&&Boolean(migrated.finances.credit),'v10 saves migrate to current schema 15 with credit state');
