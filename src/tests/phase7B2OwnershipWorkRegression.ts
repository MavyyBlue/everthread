...
export function runPhase7B2OwnershipWorkRegression(){
  ...
  check(propertyState.saveVersion===16&&founderState.saveVersion===16&&feedbackFixture.state.saveVersion===16,'34 Phase 7B2 story state remains compatible with current schema 16');
