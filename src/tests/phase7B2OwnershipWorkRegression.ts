...
export function runPhase7B2OwnershipWorkRegression(){
  ...
  check(propertyState.saveVersion===18&&founderState.saveVersion===18&&feedbackFixture.state.saveVersion===18,'34 Phase 7B2 story state remains compatible with current schema 18');
