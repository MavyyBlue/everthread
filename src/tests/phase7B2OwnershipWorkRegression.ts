...
export function runPhase7B2OwnershipWorkRegression(){
  ...
  check(propertyState.saveVersion===15&&founderState.saveVersion===15&&feedbackFixture.state.saveVersion===15,'34 Phase 7B2 story state remains compatible with current schema 15');
