...
export function runPhase7B2OwnershipWorkRegression(){
  ...
  check(propertyState.saveVersion===17&&founderState.saveVersion===17&&feedbackFixture.state.saveVersion===17,'34 Phase 7B2 story state remains compatible with current schema 17');
