...
export function runPhase7B2OwnershipWorkRegression(){
  ...
  check(propertyState.saveVersion===14&&founderState.saveVersion===14&&feedbackFixture.state.saveVersion===14,'34 Phase 7B2 story state remains compatible with current schema 14');
