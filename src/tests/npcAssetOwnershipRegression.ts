...
export function runNpcAssetOwnershipRegression(){
  ...
  verify(fresh.saveVersion===18&&SAVE_VERSION===18,'new lives and save service use current schema 18');
  ...
  verify(migrated.saveVersion===18,'v9 saves migrate to current schema 18');
