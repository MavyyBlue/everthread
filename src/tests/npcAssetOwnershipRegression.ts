...
export function runNpcAssetOwnershipRegression(){
  ...
  verify(fresh.saveVersion===13&&SAVE_VERSION===13,'new lives and save service use current schema 13');
  ...
  verify(migrated.saveVersion===13,'v9 saves migrate to current schema 13');
