...
export function runNpcAssetOwnershipRegression(){
  ...
  verify(fresh.saveVersion===17&&SAVE_VERSION===17,'new lives and save service use current schema 17');
  ...
  verify(migrated.saveVersion===17,'v9 saves migrate to current schema 17');
