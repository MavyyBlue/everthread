...
export function runNpcAssetOwnershipRegression(){
  ...
  verify(fresh.saveVersion===16&&SAVE_VERSION===16,'new lives and save service use current schema 16');
  ...
  verify(migrated.saveVersion===16,'v9 saves migrate to current schema 16');
