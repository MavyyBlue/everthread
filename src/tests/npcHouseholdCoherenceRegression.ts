...
export function runNpcHouseholdCoherenceRegression(){
  ...
  verify(restored.saveVersion===17&&relationshipType(restored,legacyNpc.id)==='spouse','current-schema save round-trip should preserve relationship truth without a schema bump');
