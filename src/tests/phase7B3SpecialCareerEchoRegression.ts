...
export function runPhase7B3SpecialCareerEchoRegression(){
  ...
  check(combatTrain.saveVersion===17&&military.saveVersion===17&&policy.state.saveVersion===17,'35 Phase 7B3 story state remains compatible with current schema 17');
