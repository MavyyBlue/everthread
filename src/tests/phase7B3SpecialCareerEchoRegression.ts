...
export function runPhase7B3SpecialCareerEchoRegression(){
  ...
  check(combatTrain.saveVersion===18&&military.saveVersion===18&&policy.state.saveVersion===18,'35 Phase 7B3 story state remains compatible with current schema 18');
