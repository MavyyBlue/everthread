...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===18,'Phase 6B1 financing remains valid under current schema 18 normalization');
