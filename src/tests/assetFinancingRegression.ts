...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===13,'Phase 6B1 financing remains valid under current schema 13 normalization');
