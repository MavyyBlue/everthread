...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===12,'Phase 6B1 financing remains valid under current schema 12 normalization');
