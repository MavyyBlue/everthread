...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===17,'Phase 6B1 financing remains valid under current schema 17 normalization');
