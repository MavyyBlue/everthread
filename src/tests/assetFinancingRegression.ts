...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===16,'Phase 6B1 financing remains valid under current schema 16 normalization');
