...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===14,'Phase 6B1 financing remains valid under current schema 14 normalization');
