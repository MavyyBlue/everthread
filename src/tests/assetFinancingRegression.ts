...
export function runAssetFinancingRegression(){
  ...
  verify(SAVE_VERSION===15,'Phase 6B1 financing remains valid under current schema 15 normalization');
