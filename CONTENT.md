...
Runs #196–#197 add **no gameplay, event, place, institution, career, education, inventory, preference, portrait-art, or location-art definitions**. QA-2 only separates compiler responsibilities and removes a redundant build-time TypeScript pass after equivalence certification. Certified content totals therefore remain **691 events / 25 Everthread town places / 29 routed institution services / 24 personal inventory items / 38 NPC preference tags**, with **624 modular Character Visual SVG components**, **3 dedicated location scenes / 10 semantic groups / 21 scene bindings / 6 selected Astra runtime assets**, and save schema **17** unchanged. Newest gameplay/content implementation remains Run #192 / `1f5c8d598b6f277f26ffda5d7683d7474141200e`; newest certified repository/QA baseline is Run #197 / `3b3b9e9d13cf882dcd20874573db895a322434c9`.
